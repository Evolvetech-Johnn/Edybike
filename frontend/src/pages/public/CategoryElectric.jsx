      ...
      <div style={{
        ...
        <div className="container">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '1rem' }}>
            <FaBolt style={{ fontSize: '2.5rem' }} />
            <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', margin: 0 }}>
              Bikes Elétricas
            </h1>
          </div>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Tecnologia e potência para ir mais longe com menos esforço
          </p>
        </div>
      </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="card fade-in">
              <div className="card-img-container" style={{ height: '250px', position: 'relative' }}>
                ...
                <div className="tag" style={{ position: 'absolute', top: '1rem', left: '1rem', background: 'linear-gradient(135deg, #8b5cf6, #6d28d9)', color: 'white' }}>
                  <FaBolt /> E-Bike
                </div>
                {!product.inStock && (
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ fontSize: '1.75rem', fontWeight: '800', color: '#8b5cf6', marginBottom: '1rem' }}>
