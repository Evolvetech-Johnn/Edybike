...
const CategoryElectric: FC = () => {
  const [products] = useState<Product[]>(electricBikes);
      ...
      <div style={{
        ...
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
             <FaBolt style={{ fontSize: '3rem', opacity: 0.9 }} />
          </div>
          <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', marginBottom: '1rem' }}>
          Bikes Elétricas
          </h1>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Potência e tecnologia para ir mais longe
          </p>
        </div>
      </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="card fade-in">
              ...
              <div className="card-img-container" style={{ height: '250px', position: 'relative' }}>
                ...
                />
                <div className="tag" style={{ position: 'absolute', top: '1rem', left: '1rem', background: '#8b5cf6', color: 'white' }}>
                    <FaBolt style={{ fontSize: '0.7rem' }} /> E-Bike
                </div>
                {!product.inStock && (
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  ...
                  <button
                    ...
                    style={{ flex: 1, background: 'linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)', border: 'none' }}
...
export default CategoryElectric;
