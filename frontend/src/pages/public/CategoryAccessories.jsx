      ...
      <div style={{
        ...
        <div className="container">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '1rem' }}>
            <FaShieldAlt style={{ fontSize: '2.5rem' }} />
            <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', margin: 0 }}>Acessórios</h1>
          </div>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Equipamentos essenciais para segurança e conforto
          </p>
        </div>
      </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="card fade-in">
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ fontSize: '1.75rem', fontWeight: '800', color: '#14b8a6', marginBottom: '1rem' }}>
