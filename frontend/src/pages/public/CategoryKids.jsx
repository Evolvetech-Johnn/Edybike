...
const CategoryKids = () => {
  const [products] = useState(kidsBikes);
      ...
      <div style={{
        ...
        <div className="container">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '1rem' }}>
            <FaChild style={{ fontSize: '2.5rem' }} />
            <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', margin: 0 }}>
              Bikes Infantis
            </h1>
          </div>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Diversão e segurança para os pequenos ciclistas
          </p>
        </div>
      </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="card fade-in">
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ fontSize: '1.75rem', fontWeight: '800', color: '#f59e0b', marginBottom: '1rem' }}>
