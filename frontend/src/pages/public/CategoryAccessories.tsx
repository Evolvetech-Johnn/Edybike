...
import { accessories, formatPrice } from '../../data/categoryProducts';
import { useCart } from '../../context/CartContext';
import { Product } from '../../types';
import { FaStar, FaShoppingCart, FaEye, FaShieldAlt } from 'react-icons/fa';

const CategoryAccessories: FC = () => {
  const [products] = useState<Product[]>(accessories);
      ...
      <div style={{
        ...
        <div className="container">
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
                <FaShieldAlt style={{ fontSize: '3rem', opacity: 0.9 }} />
            </div>
          <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', marginBottom: '1rem' }}>
          Acessórios
          </h1>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Equipamentos essenciais para sua segurança
          </p>
        </div>
      </div>
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  ...
                  <button
                    ...
                    style={{ flex: 1, background: 'linear-gradient(135deg, #14b8a6 0%, #0f766e 100%)', border: 'none' }}
