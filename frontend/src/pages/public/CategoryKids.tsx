...
import { kidsBikes, formatPrice } from '../../data/categoryProducts';
import { useCart } from '../../context/CartContext';
import { Product } from '../../types';
import { FaStar, FaShoppingCart, FaEye, FaChild } from 'react-icons/fa';

const CategoryKids: FC = () => {
  const [products] = useState<Product[]>(kidsBikes);
      ...
      <div style={{
        ...
        <div className="container">
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
                <FaChild style={{ fontSize: '3rem', opacity: 0.9 }} />
            </div>
          <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', marginBottom: '1rem' }}>
          Bikes Infantis
          </h1>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Segurança e diversão para os pequenos ciclistas
          </p>
        </div>
      </div>
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  ...
                  <button
                    ...
                    style={{ flex: 1, background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', border: 'none' }}
