...
import { parts, formatPrice } from '../../data/categoryProducts';
import { FaStar, FaShoppingCart, FaEye, FaTools } from 'react-icons/fa';

const CategoryParts = () => {
  const [products] = useState(parts);
      ...
      <div style={{
        ...
        <div className="container">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '1rem' }}>
            <FaTools style={{ fontSize: '2.5rem' }} />
            <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', margin: 0 }}>Peças para Bikes</h1>
          </div>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Componentes de alta performance para upgrade  da sua bike
          </p>
        </div>
      </div>
          ...
          {products.map((product) => (
            <div key={product.id} className="card fade-in">
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ fontSize: '1.75rem', fontWeight: '800', color: '#dc2626', marginBottom: '1rem' }}>
