...
const CategoryApparel: FC = () => {
  const [products] = useState<Product[]>(apparel);
      ...
      <div style={{
        ...
        <div className="container">
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
                <FaTshirt style={{ fontSize: '3rem', opacity: 0.9 }} />
            </div>
          <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', marginBottom: '1rem' }}>
          Vestuário
          </h1>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Estilo e conforto para todas as estações
          </p>
        </div>
      </div>
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  ...
                  <button
                    ...
                    style={{ flex: 1, background: 'linear-gradient(135deg, #ec4899 0%, #be185d 100%)', border: 'none' }}
