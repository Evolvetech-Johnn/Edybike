...
const CategoryParts: FC = () => {
  const [products] = useState<Product[]>(parts);
      ...
      <div style={{
        ...
        <div className="container">
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
                <FaTools style={{ fontSize: '3rem', opacity: 0.9 }} />
            </div>
          <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', marginBottom: '1rem' }}>
          Peças e Componentes
          </h1>
          <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
            Qualidade e performance para sua bike
          </p>
        </div>
      </div>
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  ...
                  <button
                    ...
                    style={{ flex: 1, background: 'linear-gradient(135deg, #ef4444 0%, #b91c1c 100%)', border: 'none' }}
